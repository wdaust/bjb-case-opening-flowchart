/** Shared escalation filter logic — used by ControlTower card counts
 *  AND drill-down pages so both always agree on what "overdue" means.
 *  Each filter receives the `_groupingLabel` of a detail row. */
