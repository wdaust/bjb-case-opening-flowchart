...
import { tmPhases, tmTasks } from '../../data/tmTaskData.ts';
...
export default function TMTracker() {
  ...
  // Progress
  const completedCount = tmTasks.filter((t) => statuses[t.id] === 'complete').length;
  ...
  return (
    <div className="flex-1 overflow-auto p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-foreground mb-3">25-Task Tracker</h1>
        <MockupNav active="tm-tracker" group="treatment-monitoring" />
      </div>
