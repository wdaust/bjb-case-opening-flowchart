...
import { expPhases, expTasks } from '../../data/expTaskData.ts';
...
const phaseBorderColors: Record<string, string> = {
  ...
  'orange-700': 'border-l-orange-700',
  'blue-800': 'border-l-blue-800',
  'stone-700': 'border-l-stone-700',
...
export default function ExpTracker() {
  ...
  // Progress
  const completedCount = expTasks.filter((t) => statuses[t.id] === 'complete').length;
  ...
  return (
    <div className="flex-1 overflow-auto p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-foreground mb-3">30-Task Tracker</h1>
        <MockupNav active="exp-tracker" group="expert-deposition" />
      </div>
