...
export default function TMScoring() {
  ...
  return (
    <div className="flex-1 overflow-auto p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-foreground mb-3">Treatment Monitoring — Scoring Dashboard</h1>
        <MockupNav active="tm-scoring" group="treatment-monitoring" />
      </div>

      {/* Treatment Monitoring info banner */}
      <div className="mb-6 rounded-lg border border-teal-500/30 bg-teal-500/5 p-4">
        <p className="text-sm text-foreground">
          ...
          <span className="text-muted-foreground">
            — After each client communication, all 5 scoring systems must be re-scored or have "No Change" entered within 1 hour.
          </span>
        </p>
      </div>
          ...
          return (
            ...
            >
              ...
              {noChangeFlags[sys.id] && (
                <p className="text-center text-xs text-teal-600 font-medium">No Change</p>
              )}
            </button>
          );
        })}
          ...
          <TabsContent key={sys.id} value={sys.id}>
            ...
            <div className="mt-4 flex items-center gap-3 rounded-lg border border-border bg-card p-4">
              <Button
                ...
                size="sm"
                className={noChangeFlags[activeTab] ? "bg-teal-600 hover:bg-teal-700 text-white" : ""}
