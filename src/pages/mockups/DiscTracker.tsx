...
import { discPhases, discTasks } from '../../data/discTaskData.ts';
...
const phaseBorderColors: Record<string, string> = {
  'blue-800': 'border-l-blue-800',
  'blue-700': 'border-l-blue-700',
  'blue-500': 'border-l-blue-500',
  'red-700': 'border-l-red-700',
  'indigo-900': 'border-l-indigo-900',
  'purple-700': 'border-l-purple-700',
  'pink-700': 'border-l-pink-700',
  'slate-700': 'border-l-slate-700',
};
...
export default function DiscTracker() {
  ...
  // Progress
  const completedCount = discTasks.filter((t) => statuses[t.id] === 'complete').length;
  ...
  return (
    <div className="flex-1 overflow-auto p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-foreground mb-3">26-Task Tracker</h1>
        <MockupNav active="disc-tracker" group="discovery" />
      </div>
