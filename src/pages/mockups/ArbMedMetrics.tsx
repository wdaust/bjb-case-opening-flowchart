...
import {
  arbMedMetrics, arbMedKPICategories, arbMedSLARules, arbMedEscalationTriggers,
  arbMedStageHealthIndex,
} from '../../data/arbMedMetricsData.ts';
import type { Metric } from '../../data/tmMetricsData.ts';
import type { IndexConfig } from '../../data/arbMedMetricsData.ts';
...
export default function ArbMedMetrics() {
  // Tab state
  ...
  const sortedSLARules = [...arbMedSLARules].sort((a, b) => {
    ...
    <div className="flex-1 overflow-auto p-6">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-foreground mb-3">
          Arbitration/Mediation — Scorecard &amp; KPIs
        </h1>
        <MockupNav active="arbmed-metrics" group="arbitration-mediation" />
      </div>
        ...
        <TabsContent value="scorecard">
          ...
          <div className="mt-8">
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <IndexGauge value={shiValue} config={arbMedStageHealthIndex} />
              <div className="rounded-lg border border-border bg-card p-5">
        ...
        <TabsContent value="kpi-sla">
          ...
          <section className="mb-12">
            <div className="mb-6 flex items-center justify-between flex-wrap gap-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Comprehensive KPI definitions across {arbMedKPICategories.length} categories
                </p>
              </div>
              <Button
                variant="outline"
            ...
            <div className="space-y-3">
              {arbMedKPICategories.map((category) => {
          ...
          <section className="mb-12">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              {arbMedEscalationTriggers.map((trigger) => (
                <div
                  key={trigger.id}
